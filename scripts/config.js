...
const INVITATION_CONFIG = {
    ...
    // ----------------------------------------------------------------
    // 👨‍👩‍👧‍👦 5. FAMILY & HOST DETAILS (निमंत्रक परिवार व सदस्य कॅरोसेल)
    // ----------------------------------------------------------------
    family: {
        badge: "✨ राऊत परिवार ✨",
        ...
        // 🎠 Family Members Carousel (स्वाइप करून इतर सदस्य पहा)
        members: [
            {
                name: "श्री. कल्पेश राऊत",
                role: "मुख्य निमंत्रक (Host)",
                relation: "निमंत्रक",
            ...
            },
            {
                ...
                role: "स्वागतोत्सुक (All Family Members)",
                relation: "सहकुटुंब",
                photo: "images/family.jpg",
                badge: "✨ समस्त राऊत परिवार ✨"
            }
        ]
    },
